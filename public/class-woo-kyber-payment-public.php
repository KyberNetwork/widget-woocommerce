...
class Woo_Kyber_Payment_Public {
	...
	public function enqueue_styles() {
        ...
        wp_enqueue_style( "woo-kyber-payment-widget-css", 'https://widget.kyber.network/v0.6/widget.css', array(), "", 'all' );
	...
	public function enqueue_scripts() {
        ...
        wp_enqueue_script( "woo-kyber-payment-widget-js", 'https://widget.kyber.network/v0.6/widget.js', array(), $this->version, true);
